...
<head>
  ...
  <title>Informações do Autônomo</title>
  ...
  <link rel="stylesheet" type="text/css" href="jvRGZy/css/style.css">
...
<body>
  ...
  <div class="maain-content">
    ...
    <main class="main">
      <h2 class="daash-title" style="margin-bottom: -30px;">Informações do Autônomo</h2>
      <section class="reecent" style="margin-bottom: 2rem;">
                      ...
                      <div class="profile-card-loc">
                        <?php
                          if ($cidade == "" and $estado == "") {
                            ...
                            echo '<span class="profile-card-loc__icon">
  ...
  <script type="text/javascript" src="jvRGZy/js/index.js"></script>
